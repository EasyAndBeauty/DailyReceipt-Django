"""swagger_auto_schema를 사용하여 API 문서화"""
            ...
            schema=openapi.Schema(
                ...
                properties={
                    "error": openapi.Schema(
                        type=openapi.TYPE_STRING, example="Only available in debug mode"
                    )
                },
            ),
        ),
...
@swagger_auto_schema(
    ...
    responses={
        ...
        400: openapi.Schema(
            ...
            properties={
                "error": openapi.Schema(
                    type=openapi.TYPE_STRING, example="Invalid token provided"
                )
            },
        ),
    },
...
def social_auth(request):
    ...
    Requires:
    - id_token: The Firebase ID token from social login
